...
const Lightning = ({
  ...
  useEffect(() => {
    ...
    // Get uniform locations after the program is linked and used
    ...
    const render = () => {
      ...
      // Make sure the program is active before setting uniforms
      gl.useProgram(program);
    ...
    return () => {
      ...
      gl.useProgram(null); // Unbind the program before deleting
